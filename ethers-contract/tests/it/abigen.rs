...
//
//     let encoded_call = contract.encode_with_selector([15, 244, 201, 22],
// call.other_value).unwrap();     assert_eq!(encoded_call, call.clone().encode());
...
// "ethers-contract/tests/solidity-contracts/abiencoderv2test_abi.json",);     let anvil =
...
//         "fulfillAdvancedOrder(((address,address,(uint8,address,uint256,uint256,uint256)[],(uint8,
// address,uint256,uint256,uint256,address)[],uint8,uint256,uint256,bytes32,uint256,bytes32,
// uint256),uint120,uint120,bytes,bytes),(uint256,uint8,uint256,uint256,bytes32[])[],bytes32,
// address)"     );
...
//         WyvernExchangeV1,
//         r#"[
//         function atomicMatch_(address[14] addrs, uint[18] uints, uint8[8]
// feeMethodsSidesKindsHowToCalls, bytes calldataBuy, bytes calldataSell, bytes
// replacementPatternBuy, bytes replacementPatternSell, bytes staticExtradataBuy, bytes
// staticExtradataSell, uint8[2] vs, bytes32[5] rssMetadata) public payable     ]"#,
//     );
// }
//
// #[test]
